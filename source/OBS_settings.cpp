...
void OBS_settings::getFFmpegOutputRecordingSettings(Local<Array>* subCategoryParameters, config_t* config)
{
	...
	if(formatDesc != NULL) {
		...
		// 	Local<Object> object = Object::New(isolate);
		// 	object->Set(String::NewFromUtf8(isolate, codec->long_name),
		// 					String::NewFromUtf8(isolate, codec->name));
		// 	FFAEncoderValues->Set(0, object);
		// 	config_set_int(config, "AdvOut", "FFVEncoderId", FF_CODEC_AUDIO);
		// }
		// if (ff_format_desc_has_video(formatDesc)) {
		// 	Local<Object> object = Object::New(isolate);
		// 	object->Set(String::NewFromUtf8(isolate, codec->long_name),
		// 					String::NewFromUtf8(isolate, codec->name));
		// 	FFVEncoderValues->Set(0, object);
		// 	config_set_int(config, "AdvOut", "FFVEncoderId", FF_CODEC_VIDEO);
		// }
	}
